...
<head>
    ...
    <title>PPDB SMP NEGERI 4 TAPUNG</title>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> SMP NEGERI 4 TAPUNG</strong></h2>
                                   ...
                                   <div class="col-md-12" >
                                       ...
                                       <div class="form-group" style="padding-bottom:30px;">
                                          <div class="radio bg-success" style="padding-top:10px;padding-bottom:10px;border-radius:3px;color:#222;" >
                                             <label>
                                               <input type="radio" value="cek" name="cek" data-parsley-group="block0" data-radio="iradio_square-blue" data-parsley-errors-container='div[id="condition-ck"]' required> <b>Saya setuju</b>
 																					   </label>
                        ...
                        <fieldset>
                           ...
                           <div class="form-group" >
                              ...
                              <span style="font-size:15px">
                                 Proses PPDB Online SMP NEGERI 4 TAPUNG  hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                 <br><br>
                                 <div class="col-md-12" >
          ...
          <div class="footer">
            <div class="copyright">
              <p class="pull-left sm-pull-reset">
                <span>Copyright &copy; <a href="" target="_blank">Nadia & Annisah |</a> <?php echo date('Y'); ?> | IT Development</span>
              </p>
            </div>
          </div>
        </div>
